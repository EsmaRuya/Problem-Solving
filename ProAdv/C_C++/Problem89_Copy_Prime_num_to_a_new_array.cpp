...
using namespace std;
/*
Write a program to fill an array with max size 100 with random numbers from 1 to 100, then copy only prime numbers to another array using "addNumberToArray" function, and print it.
*/
