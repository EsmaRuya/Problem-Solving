...
using namespace std;
/*
Write a program to fill an array with max size 100 with random numbers from 1 to 100, then read number and return its index in array if found, otherwise return-1.
*/
